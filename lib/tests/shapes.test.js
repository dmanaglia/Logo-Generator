...
describe("Circle", () => {
  ...
  test("should throw error for invalid color", () => {
    const expectedErr = 'You must enter a valid color.';
    const circle = new Circle();
    expect(() => circle.setColor("plurple")).toThrow(expectedErr);
  });
});
...
describe("Triangle", () => {
  ...
  test("should throw error for invalid color", () => {
    const expectedErr = 'You must enter a valid color.';
    const triangle = new Triangle();
    expect(() => triangle.setColor("plurple")).toThrow(expectedErr);
  });
});
...
describe("Square", () => {
  ...
  test("should throw error for invalid color", () => {
    const expectedErr = 'You must enter a valid color.';
    const square = new Square();
    expect(() => square.setColor("plurple")).toThrow(expectedErr);
  });
});
